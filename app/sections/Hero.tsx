...
export function Hero() {
  ...
  return (
    ...
    >
      {/* Central video — not a fixed background */}
      <div className="relative w-full max-w-5xl mx-auto px-4 sm:px-6 md:px-12 z-0">
        <div className="relative aspect-video rounded-2xl overflow-hidden shadow-2xl shadow-[#caa24f]/10 border border-[#f3efe9]/10">
          <video
            autoPlay
            muted
            loop
            ...
            aria-label="Video de papelería artesanal"
          >
            <source
          ...
          {/* Soft vignette / spotlight over the video */}
          <div
            className="absolute inset-0 pointer-events-none"
            style={{
              background:
                "radial-gradient(circle at center, transparent 30%, rgba(5,5,5,0.55) 100%)",
            }}
          />
        </div>
      </div>

      {/* Hero copy layered over the video and bottom of the screen */}
      <div className="absolute inset-x-0 bottom-0 z-10 px-4 sm:px-6 md:px-12 pb-12 md:pb-20 pt-32 max-w-7xl mx-auto w-full">
