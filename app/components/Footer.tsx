...
export function Footer() {
  ...
  return (
    <footer className="bg-[#1c1917] text-[#f3efe9]" id="contacto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 py-16 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div>
            ...
            <div className="flex gap-4">
              <a
                ...
                className="w-10 h-10 rounded-full border border-[#f3efe9]/20 flex items-center justify-center hover:border-[#c9a87c] hover:text-[#c9a87c] transition-colors"
          ...
          <div>
            <h4 className="font-medium text-sm tracking-[0.2em] uppercase text-[#c9a87c] mb-6">
              Enlaces Rápidos
            </h4>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3 text-sm text-[#f3efe9]/70">
                <MapPin size={18} className="shrink-0 mt-0.5 text-[#c9a87c]" />
                <span>{company.contact.address.full}</span>
              </li>
              <li className="flex items-center gap-3 text-sm text-[#f3efe9]/70">
                <Phone size={18} className="shrink-0 text-[#c9a87c]" />
                <span>{company.contact.phone}</span>
              </li>
              <li className="flex items-center gap-3 text-sm text-[#f3efe9]/70">
                <Mail size={18} className="shrink-0 text-[#c9a87c]" />
                <span>{company.contact.email}</span>
              </li>
              <li className="flex items-start gap-3 text-sm text-[#f3efe9]/70">
                <Clock size={18} className="shrink-0 mt-0.5 text-[#c9a87c]" />
                <div>
